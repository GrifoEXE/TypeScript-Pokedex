...
var showPokemon = function (pokemon) {
	var output =
		'\n        <a class="card" href = "https://www.pokemon.com/br/pokedex/'
			.concat(
				pokemon.name,
				'" target="_blank">\n            <span class="card--id">#'
			)
			.concat(pokemon.id, '</span>\n            <img class="card--image" src=')
			.concat(pokemon.image, " alt=")
			.concat(pokemon.name, ' />\n            <h1 class="card--name">')
			.concat(pokemon.name, '</h1>\n            <span class="card--type--')
			.concat(pokemon.type1, '">')
			.concat(pokemon.type1, '</span>\n\t\t\t<span class="card--type--')
			.concat(pokemon.type2, '">')
			.concat(pokemon.type2, "</span>\n        </a>\n    ");
		...
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					return [
						4 /*yield*/,
						fetch("https://pokeapi.co/api/v2/pokemon/".concat(id)),
					];
				case 1:
					data = _a.sent();
